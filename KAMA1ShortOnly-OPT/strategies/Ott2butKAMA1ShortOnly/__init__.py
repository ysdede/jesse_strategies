...
class Ott2butKAMA1ShortOnly(Strategy):
    ...
    def hyperparameters(self):
        return [
            {'name': 'ott_len', 'type': int, 'min': 2, 'max': 50, 'default': 22},
            {'name': 'ott_percent', 'type': int, 'min': 50, 'max': 800, 'default': 667},
            {'name': 'stop_loss', 'type': int, 'min': 50, 'max': 400, 'default': 50},
            {'name': 'risk_reward', 'type': int, 'min': 10, 'max': 80, 'default': 11},
            {'name': 'chop_rsi_len', 'type': int, 'min': 5, 'max': 50, 'default': 34},
            {'name': 'chop_bandwidth', 'type': int, 'min': 10, 'max': 300, 'default': 194},
        ]
    ...
    def should_long(self):
        return False  # self.cross_up and self.chop[-1] > self.chop_upper_band
