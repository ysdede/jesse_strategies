...
sudo mount -t tmpfs -o size=32G ramdisk /tmp/ramdisk
mount | tail -n 1
...
# Batch import
jesse-tk bulk spot btc-usdt $1 --workers 6
jesse-tk bulk spot eth-usdt $1 --workers 6
jesse-tk bulk spot bnb-usdt $1 --workers 6
