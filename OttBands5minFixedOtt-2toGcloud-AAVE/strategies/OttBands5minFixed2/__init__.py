...
class OttBands5minFixed2(Strategy):
    ...
    def hyperparameters(self):
        return [
            {'name': 'ott_len', 'type': int, 'min': 10, 'max': 50, 'default': 31},
            {'name': 'ott_percent', 'type': int, 'min': 100, 'max': 300, 'default': 244},
            {'name': 'ott_bw', 'type': int, 'min': 50, 'max': 180, 'default': 119},
            {'name': 'tps_qty_index', 'type': int, 'min': 0, 'max': 125, 'default': 79},
            {'name': 'max_risk', 'type': int, 'min': 10, 'max': 65, 'default': 27},
            #
        ]
