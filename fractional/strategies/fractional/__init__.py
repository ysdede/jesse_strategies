...
# Inherit from ott2butKAMA2-400daysRe3
class fractional(Strategy):
    def __init__(self):
        super().__init__()
        self.trade_ts = None
    ...
    def hyperparameters(self):
        return [
            {'name': 'ott_ma_len', 'type': int, 'min': 40, 'max': 1100, 'default': 655},
            {'name': 'ott_percent', 'type': int, 'min': 1000, 'max': 6000, 'default': 1940},
            {'name': 'stop_loss', 'type': int, 'min': 1500, 'max': 3000, 'default': 1990},
            {'name': 'risk_reward', 'type': int, 'min': 400, 'max': 1200, 'default': 880},
            {'name': 'chop_bandwidth', 'type': int, 'min': 1200, 'max': 3200, 'default': 3000},
        ]
