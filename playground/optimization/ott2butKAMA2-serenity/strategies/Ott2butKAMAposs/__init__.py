...
class Ott2butKAMAposs(Strategy):
    def __init__(self):
        super().__init__()
        self.trade_ts = None
    ...
    def hyperparameters(self):
        return [
            {'name': 'ott_len', 'type': int, 'min': 2, 'max': 75, 'default': 45},
            {'name': 'ott_percent', 'type': int, 'min': 100, 'max': 800, 'default': 419},
            {'name': 'stop_loss', 'type': int, 'min': 50, 'max': 400, 'default': 90},
            {'name': 'risk_reward', 'type': int, 'min': 10, 'max': 80, 'default': 49},
            {'name': 'chop_rsi_len', 'type': int, 'min': 2, 'max': 75, 'default': 6},
            {'name': 'chop_bandwidth', 'type': int, 'min': 10, 'max': 350, 'default': 178},
        ]
