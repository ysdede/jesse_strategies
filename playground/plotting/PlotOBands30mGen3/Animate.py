...
os.chdir(os.getcwd())
validate_cwd()
idf = get_candles_as_df('Binance Futures', 'BTC-USDT', '5m', '2021-10-01', '2021-10-10')
...
fig, axes = mpf.plot(df, type='candle', addplot=apds, figscale=1.8, figratio=(8, 5), title='\n\nMACD',
                     style=s, volume=True, volume_panel=2, panel_ratios=(6, 2, 1), returnfig=True)
